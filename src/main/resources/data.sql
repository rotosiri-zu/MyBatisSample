...
-- booksテーブルへのデータ登録
INSERT INTO books (title, author) VALUES ('新人研修あるある', '山田太郎', 1);
INSERT INTO books (title, author) VALUES ('こんなDBエンジニアは嫌だ', '佐藤花子', 2);
INSERT INTO books (title, author) VALUES ('本当にあったIT業界トラブル','鈴木一郎', 1);
...
INSERT INTO reviews (book_id, review_text) VALUES (2, '自分の職場には来てほしくないです。');
INSERT INTO reviews (book_id, review_text) VALUES (2, '同じ様な方が、私の職場にいます。。。');
